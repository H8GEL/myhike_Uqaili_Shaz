    ...
    db.collection(collection) 
        ...
        .then(allHikes=> {
            ...
            allHikes.forEach(doc => { //iterate thru each doc
                ...
                newcard.querySelector('a').href = "eachHike.html?docID="+docID; //link to eachHike.html

                //Optional: give unique ids to all elements for future use
                newcard.querySelector('i').id = 'save-' + docID;   //guarantees the i tags will be unique for each document
